...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //load data
        queList.add(new QuestionClass( "Which company owns the android?","Google","Apple","Nokia","Samsung","Google"));
        queList.add(new QuestionClass("Which one is not the programming language?", "php","java","html","j2E",  "html"));
        queList.add(new QuestionClass( "what is the first operating system for pc?", "macos","windows","linux","chromos", "windows"));
        //init conter
        conter = 0;
        ...
        tm = new CountDownTimer(12 * 1000, 1000) {
            ...
            @Override
            public void onTick(long millisUntilFinished) {tvTimer.setText("" + millisUntilFinished / 1000);
            }
